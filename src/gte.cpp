...
void refreshScreen() {
	...
	if (fbcf) {
		//ImGui::GetForegroundDrawList()->AddRectFilled(ImVec2(10, 10), ImVec2(580, 70), IM_COL32(0, 0, 0, 180));
		ImGui::GetForegroundDrawList()->AddText(NULL, 22.0f, ImVec2(20, 60), IM_COL32(0, 255, 128, 255), "[ fbcf: ON ]");
	} else {
		//ImGui::GetForegroundDrawList()->AddRectFilled(ImVec2(10, 10), ImVec2(500, 70), IM_COL32(0, 0, 0, 180));
		ImGui::GetForegroundDrawList()->AddText(NULL, 22.0f, ImVec2(20, 60), IM_COL32(255, 80, 80, 255), "[ fbcf: OFF ]");
	}
	ImGui::Render();
